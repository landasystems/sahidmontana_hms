...
class HotelTransController extends Controller
{
        public $breadcrumbs;
	/**
	...
	{
		$model=new HotelTrans;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['HotelTrans']))
		{
			$model->attributes=$_POST['HotelTrans'];
			if($model->save())
	...
	{
		$model=HotelTrans::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hotel-trans-form')
		{
