...
class RoomPackageController extends Controller
{
	...
	{
		$model=new RoomPackage;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['RoomPackage']))
		{
			$model->attributes=$_POST['RoomPackage'];
			if($model->save())
	...
	{
		$model=RoomPackage::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='room-package-form')
		{
