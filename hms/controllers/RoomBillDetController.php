...
class RoomBillDetController extends Controller
{
	...
	{
		$model=new RoomBillDet;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['RoomBillDet']))
		{
			$model->attributes=$_POST['RoomBillDet'];
			if($model->save())
	...
	{
		$model=RoomBillDet::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='room-bill-det-form')
		{
