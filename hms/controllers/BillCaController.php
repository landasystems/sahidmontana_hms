...
class BillCaController extends Controller
{
        public $breadcrumbs;
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BillCa']))
		{
			$model->attributes=$_POST['BillCa'];
			if($model->save())
	...
	{
		$model=BillCa::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bill-ca-form')
		{
