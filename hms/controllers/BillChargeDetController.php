...
class BillChargeDetController extends Controller
{
	...
	{
		$model=new BillChargeDet;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['BillChargeDet']))
		{
			$model->attributes=$_POST['BillChargeDet'];
			if($model->save())
	...
	{
		$model=BillChargeDet::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bill-charge-det-form')
		{
