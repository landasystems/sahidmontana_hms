...
class NaBalanceController extends Controller
{
        public $breadcrumbs;
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['NaBalance']))
		{
			$model->attributes=$_POST['NaBalance'];
			if($model->save())
	...
	{		
            $criteria = new CDbCriteria();            
                ...
                $model=new NaBalance('search');
                $model->unsetAttributes();  // clear any default values

                if(isset($_GET['NaBalance']))
		{
                        $model->attributes=$_GET['NaBalance'];
	...
	{
		$model=NaBalance::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='na-balance-form')
		{
