...
/**
 * This is the model class for table "{{na_dsr}}".
 *
 * The followings are the available columns in table '{{na_dsr}}':
 * @property integer $id
 ...
 */
class NaDsr extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('na_id, today, mtd_actual, mtd_forecast, mtd_last_month, 
                            ytd_actual, ytd_forecast, tax_service, created, created_user_id, modified', 'safe'),
	 ...
	 * @return NaDsr the static model class
	 */
