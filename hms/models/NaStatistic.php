...
/**
 * This is the model class for table "{{na_statistic}}".
 *
 * The followings are the available columns in table '{{na_statistic}}':
 * @property integer $id
 ...
 */
class NaStatistic extends CActiveRecord
{
	/**
	 ...
	 * @return NaStatistic the static model class
	 */
