...
/**
 * This is the model class for table "{{na_foodpercover_analys}}".
 *
 * The followings are the available columns in table '{{na_foodpercover_analys}}':
 * @property integer $id
 ...
 */
class NaFoodpercoverAnalys extends CActiveRecord
{
	/**
	 ...
	 * @return NaFoodpercoverAnalys the static model class
	 */
