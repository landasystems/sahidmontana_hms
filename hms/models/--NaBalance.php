...
/**
 * This is the model class for table "{{na_balance}}".
 *
 * The followings are the available columns in table '{{na_balance}}':
 * @property integer $id
 ...
 */
class NaBalance extends CActiveRecord
{
	/**
	 ...
	 * @return NaBalance the static model class
	 */
