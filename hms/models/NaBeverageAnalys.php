...
/**
 * This is the model class for table "{{na_beverage_analys}}".
 *
 * The followings are the available columns in table '{{na_beverage_analys}}':
 * @property integer $id
 ...
 */
class NaBeverageAnalys extends CActiveRecord
{
	/**
	 ...
	 * @return NaBeverageAnalys the static model class
	 */
