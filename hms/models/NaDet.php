...
/**
 * This is the model class for table "{{na_det}}".
 *
 * The followings are the available columns in table '{{na_det}}':
 * @property integer $id
 * @property integer $na_id
 * @property integer $room_bill_id
 * @property integer $bill_id
 * @property integer $deposite_id
 * @property integer $bill_charge_id
 */
class NaDet extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(			
			array('na_id, room_bill_id,registration_id, bill_id, deposite_id, bill_charge_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, na_id,is_checkedout, room_bill_id, bill_id, deposite_id, bill_charge_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('deposite_id',$this->deposite_id);
	 ...
	 * @return NaDet the static model class
	 */
