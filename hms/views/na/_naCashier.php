<center><h3>GENERAL CASHIER SHEET</h3></center>
...
<table class="table ">
    <thead>
        <tr>
            ...
            <th class="span2" rowspan="2" style="vertical-align:middle;text-align: center;">Code Trans</th>
            <th class="span2" rowspan="2" style="vertical-align:middle;text-align: center;">Room Number</th>
...
//        $bills = Bill::model()->findAll(array('condition' => 'created_user_id=' . Yii::app()->user->id . ' and is_cashier=0'));
        ...
        foreach ($bills as $bill) {
            ...
            $row .= '<td style="text-align:left">' . $bill->Cashier->name . '</td>';
            $row .= '</tr>';
            echo $row;
            $no++;
        }
...
//                $tipe = ($dp->is_walk_in_cash == 1) ? "Walk In Cash" : "Guest Deposite";
            ...
            $row .= '<td style="text-align:left">' . $dp->Cashier->name . '</td>';
            $row .= '</tr>';
            echo $row;
            $no++;
        }
...
//            $roombill = RoomBill::model()->findAll(array('condition' => 'id=' . $trans->gl_room_bill_id));
            ...
            $row .= '<td style="text-align:left">' . $trans->Cashier->name . '</td>';
            $row .= '</tr>';
            echo $row;
            $no++;
        }
        ...
        <tr style="height:40px !important;">
            ...
            <th style="text-align: right !important"><input type="hidden" name="cash" value="<?php echo $tot_cash ?>"><?php echo landa()->rp($tot_cash, false); ?></th>
