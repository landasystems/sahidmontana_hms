...
//$roomBills_By_Registration = RoomBill::model()->findAll(array('order' => 't.id', 'condition' => '(is_checkedout=0 and t.is_na=0 and date_bill<="' . $siteConfig->date_system . '") or (date_format(Bill.created,"%Y-%m-%d")="' . $siteConfig->date_system . '")', 'group' => 'registration_id', 'index' => 'id', 'with' => array('BillDet', 'BillDet.Bill')));
