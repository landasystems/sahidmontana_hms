<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dp_by')); ?>:</b>
	<?php echo CHtml::encode($data->dp_by); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_applied')); ?>:</b>
	<?php echo CHtml::encode($data->is_applied); ?>
	<br />
