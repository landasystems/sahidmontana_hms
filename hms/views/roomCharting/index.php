...
<div class="well">
    <div class="row-fluid">
        <div class="span12">
            ...
            ?>
            Tahun : <?php echo CHtml::dropDownList('year', (!empty($_POST['year'])) ? $_POST['year'] : date('Y',strtotime($siteConfig->date_system)), landa()->yearly(date('Y') - 1), array('empty' => 'Please Choose')); ?> &nbsp;&nbsp;
            Bulan : <?php echo CHtml::dropDownList('month', (!empty($_POST['month'])) ? $_POST['month'] : date('n',strtotime($siteConfig->date_system)), landa()->monthly(), array('empty' => 'Please Choose')); ?>&nbsp;&nbsp;
