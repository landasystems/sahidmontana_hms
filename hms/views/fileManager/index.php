...
<div class="well">
    <ul>
        <li>Halaman ini merupakan file manager untuk website Anda, didalam area ini anda dapat melakukan operasi file (Upload, Create, Edit, Hapus, Preview, Rename, dll)</li>
