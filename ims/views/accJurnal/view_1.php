...
<div class="form">
    ...
    <div class="box gradient invoice">
        ...
        <div class="title clearfix">
            <h4 class="left">
                <span class="number">#<?php echo $model->code_acc; ?></span>
                <br><span class="data gray"><?php echo date('d-M-Y',  strtotime($model->date_posting))?></span>
            </h4>
                ...
                <table class="responsive table table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><?php echo landa()->rp($model->total_debet) ?></td>
                            <td><?php echo landa()->rp($model->total_credit) ?></td>
                        </tr>
                    </tfoot>
                </table>
                <br>
...
<div id="printableArea" style="width: 100%;display: none">
    ...
    for ($i = 0; $i < $batas; $i++) {
        ...
        if (!empty($val[$i])) {
            ...
            $detailCash .= '<tr>                        
                                ...
                                <td class="print" style="text-align:center">' . $val[$i]->AccJurnal->code . '</td>                                            
                                <td class="print">' . $accCoaName . '</td>
                                <td class="print" style="text-align:right">' . landa()->rp($val[$i]->debet, false) . '</td>    
                                <td class="print" style="text-align:right">' . landa()->rp($val[$i]->credit, false) . '</td>    
                           </tr>';
        } else {
            $detailCash .= '<tr>                        
                                <td class="print">&nbsp;</td>
    ...
    $detailCash .= '<tr>  
                        ...
                        <td class="print" style="text-align:right">' . landa()->rp($model->total_debet, false) . '</td>
                        <td class="print" style="text-align:right">' . landa()->rp($model->total_credit, false) . '</td>
                    </tr>
                    </table>';
