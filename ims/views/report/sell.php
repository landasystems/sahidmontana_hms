...
if (isset($mBuy->created)) {
    ...
    $buyReport = Sell::model()->findAll(array('condition' => '(created >="' . $start . '" AND created <="' . $end . '") '. $departementId, 'order' => 'id'));
    $this->renderPartial('_sellResult', array('buy' => $buyReport, 'departement' => $departementName, 'created' => $mBuy->created));
}
?>
