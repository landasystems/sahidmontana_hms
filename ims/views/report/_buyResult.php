...
<table width="100%">
    <tr>
        <td  style="text-align: center" colspan="3"><h2>BUY REPORT</h2>
    ...
    <tbody>
        ...
        foreach ($buy as $o) {
            ...
            echo '<tr>
                    ...
                    <a class="btn btn-small view" target="_blank" title="View Detail" rel="tooltip" href="../buy/' . $o->id . '"><i class="icon-eye-open"></i></a>
                    </td>
                <tr>';
        }
        ?>
