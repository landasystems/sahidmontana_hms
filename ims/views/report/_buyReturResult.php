...
<table width="100%">
    <tr>
        <td  style="text-align: center" colspan="3"><h2>BUY REETUR REPORT</h2>
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        foreach ($buy as $o) {
            ...
            echo '<tr>
                    ...
                    <td>' . $o->ProductSupplier->name. '</td>
                    <td>' . landa()->rp($subtotal) . '</td>
                    <td>' . landa()->rp($other) . '</td>
                    <td>' . landa()->rp($total) . '</td>                    
                    <td style="text-align:center">
                    <a class="btn btn-small view" target="_blank" title="View Detail" rel="tooltip" href="../buyRetur/' . $o->id . '"><i class="icon-eye-open"></i></a>
                    </td>
                <tr>';
        }
        ?>
    ...
    <tfoot>
        <tr>
            <th colspan="7">Total Retur Buy</th>            
