...
?>
<?php
$this->setPageTitle('Laporan Pembelian');
...
if (isset($mBuy->created)) {
    ...
    $buyReport = Buy::model()->findAll(array('condition' => '(created >="' . $start . '" AND created <="' . $end . '") ' . $departementId . $supplierId, 'order' => 'id'));
    $this->renderPartial('_buyResult', array('buy' => $buyReport, 'supplierName' => $supplierName, 'departement' => $departementName, 'created' => $mBuy->created));
}
?>