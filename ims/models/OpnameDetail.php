 ...
 * @property integer $id
 * @property string $opname_id
 * @property string $product_id
 * @property string $qty
 * @property string $qty_opname
 */
class OpnameDetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('opname_id, product_id, qty, qty_opname', 'length', 'max'=>45),
	...
	public function search()
	{
		...
		$criteria->compare('opname_id',$this->opname_id,true);
		$criteria->compare('product_id',$this->product_id,true);
		$criteria->compare('qty',$this->qty,true);
		$criteria->compare('qty_opname',$this->qty_opname,true);
