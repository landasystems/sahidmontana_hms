    ...
    public function modules($arg = NULL) {
        ...
        if ($appName == 'Content Management Systems') {
            ...
            return array(
                ...
                array('visible' => landa()->checkAccess('Customer', 'r') || landa()->checkAccess('Customer', 'r'), 'label' => '<span class="icon16 wpzoom-user-2"></span>Guest', 'url' => array('#'), 'submenuOptions' => array('class' => 'sub'), 'items' => array(
                        array('label' => '<span class="icon16 entypo-icon-users"></span>Group Guest', 'url' => array('/landa/roles/customer'), 'auth_id' => 'GroupCustomer'),
                        array('label' => '<span class="icon16  entypo-icon-user"></span>Guest', 'url' => array('/user/customer'), 'auth_id' => 'Customer'),
                        array('label' => '<span class="icon16  cut-icon-list"></span>Guest Invoice', 'url' => array('/user/userInvoice','type' => 'customer'), 'auth_id' => 'Customer'),
                    )),
