...
/**
 * This is the model class for table "acc_cash_out".
 *
 * The followings are the available columns in table 'acc_cash_out':
 * @property integer $id
 ...
 */
class AccCashOut extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('created, total, modified, date_posting', 'safe'),
    ...
    public function relations() {
        ...
        return array(
            'AccCasOutDet' => array(self::HAS_MANY, 'AccCashOutDet', 'id'),
...
//            do nothing
     ...
     * @return AccCashOut the static model class
     */
