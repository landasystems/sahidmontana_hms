...
class LandaFeaturedProduct extends CWidget {
...
//    $stock= ProductStock::model()->departement($model->stock, $siteConfig->departement_id);
        if ($siteConfig->product_layout == 1) {
            ...
            $stock= ProductStock::model()->departement($m->stock, $siteConfig->departement_id);
                ...
                <div class="thumbnail">
                        <a href="' . $m->url . '"><center><img src="' . $m->imgUrl['medium'] . '" style="max-height: 100%;" alt=""></center></a>
                </div>
...
';
           ...
           $this->registerScript();
            ...
            foreach ($model as $m) {
                ...
                <li class="span3 ">
                <div class="thumbnail">
                        <a href="' . $m->url . '"><center><img src="' . $m->imgUrl['small'] . '" style="max-height: 100%;" alt=""></center></a>
                </div>
                <div class="thumbSetting">
                        <div class="nama">
                                <h3>
