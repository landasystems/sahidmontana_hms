...
class SchoolYear extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, school_year', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 */
	  public function relations() {
        ...
        return array(
            'Classroom' => array(self::HAS_MANY, 'Classroom', 'id'),
        );
          }
	...
	public function search()
	{
        ...
        public function listData(){
            return CHtml::listData($this->findAll(array('order'=>'school_year DESC')), 'id', 'school_year');
        }
}