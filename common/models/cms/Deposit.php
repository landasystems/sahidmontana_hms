...
class Payment extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, trans_number,module, amount,bank_account, self_name, self_account_number, description, status, created, created_user_id, modified', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'trans_number' => 'Nota',
            'bank_account' => 'Bank Destination',
            'self_name' => 'Name',
            'User.name' => 'User Name',
            'self_account_number' => 'Account Number',
