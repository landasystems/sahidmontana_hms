...
//    public $param;
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, title, article_category_id, content, primary_image, created, created_user_id, modified', 'safe', 'on' => 'search'),
...
//            array('primary_image', 'file', 'types' => 'jpg, gif, png, jpeg'),
    ...
    public function getUrl(){
        return url('read/' . $this->ArticleCategory->alias . '/' . $this->alias);
    }
